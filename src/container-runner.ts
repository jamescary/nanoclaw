...
function buildVolumeMounts(
  ...
  if (isMain) {
    ...
    // Apple Container only supports directory mounts, so we cannot overlay /dev/null
    // from the host. The entrypoint starts as root, shadows .env, then drops privileges.
